...
public class Activity10 {
    ...
    public static Object[][] signUpInfo() {
        String filePath = "src/test/java/activities/Activity10.xlsx";
    ...
    public void registrationTest(List<Object> rows) {
        ...
        BigInteger phone_number = new BigDecimal(rows.get(4).toString()).toBigInteger();
        phoneNumberField.sendKeys(phone_number.toString());

        // Click on the submit button
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input.green"))).click();
