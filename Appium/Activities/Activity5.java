...
public class Activity5 {
    ...
    public void smsTest() {
        ...
        String messageTextSent= wait.until(ExpectedConditions.visibilityOf(driver.findElement
        		(AppiumBy.id("com.google.android.apps.messaging:id/message_text")))).getText();
        // Assertion
